...
YEAR: for (my $yyyy=$year; $yyyy <= $yearmax; $yyyy++)  {
     ...
     my $firsttwo = DateRDFUtils::year2firsttwo($yyyy);
     ...
     my $output = <<"EOF";
      <rdf:Description rdf:about="https://vocabs.acdh.oeaw.ac.at/date/00$yyyy">
        ...
        <skos:prefLabel xml:lang="en">00$yyyy</skos:prefLabel>
        <rdfs:label rdf:datatype="xsd:gYear">00$yyyy</rdfs:label>
        <skos:altLabel xml:lang="en">AD $yyyy</skos:altLabel>
        <skos:definition xml:lang="en">Year 00$yyyy in ISO8601 (the Gregorian and proleptic Gregorian calendar). AD $yyyy.</skos:definition>
        ...
        <skos:broader rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/0${decade}0"/>
        <time:intervalMeets rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/00$yyyyplus"/>
        <time:intervalMetBy rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/00$yyyyminus"/>
      </rdf:Description>
