...
YEAR: for (my $yyyy=$year; $yyyy <= $yearmax; $yyyy++)  {
   MONTH: foreach my $mm ( qw(01 02 03 04 05 06 07 08 09 10 11 12) ) {
    ...
    my $output =  << "EOF";
      <rdf:Description rdf:about="https://vocabs.acdh.oeaw.ac.at/date/0$yyyy-$mm">
        ...
        <skos:prefLabel xml:lang="en">0$yyyy-$mm</skos:prefLabel>
        <rdfs:label rdf:datatype="xsd:gYearMonth">0$yyyy-$mm</rdfs:label>
        <skos:altLabel xml:lang="en">$mmtxt 0$yyyy</skos:altLabel>
        <skos:altLabel xml:lang="en">$mm-0$yyyy</skos:altLabel>
        <skos:altLabel xml:lang="en">$mm/0$yyyy</skos:altLabel>
        <skos:definition xml:lang="en">0$yyyy-$mm in ISO8601 (the Gregorian and proleptic Gregorian calendar).</skos:definition>
        ...
        <skos:broader rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/0$yyyy"/>
        <time:intervalMeets rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/0$yyyy-0$mmplus"/>
        <time:intervalMetBy rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/0$yyyy-0$mmminus"/>
      </rdf:Description>
