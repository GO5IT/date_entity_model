...
YEAR: for (my $yyyy=$year; $yyyy <= $yearmax; $yyyy++)  {
     ...
     my $ccminus = $cc -1;
     my $ccminusrev = $ccminus * -1;
     my $ccrev = $cc * -1;
     my $ccrevminus = $ccrev - 1;
     ...
     my $output = <<"EOF";
      <rdf:Description rdf:about="https://vocabs.acdh.oeaw.ac.at/date/-0${decaderev}">
        ...
        <skos:prefLabel xml:lang="en">${decaderev}0s BC</skos:prefLabel>
        <rdfs:label xml:lang="en">${decaderev}0s BC</rdfs:label>
        <skos:altLabel xml:lang="en"> -0${decaderev}8/-0${decaderevminus}9</skos:altLabel>
        <skos:altLabel xml:lang="en"> ${decaderev}9 BC - ${decaderev}0 BC</skos:altLabel>
        <skos:definition xml:lang="en">A decade from -0${decaderev}8 to -0${decaderevminus}9 in ISO8601 (the Gregorian and proleptic Gregorian calendar). From ${decaderev}9 BC to ${decaderev}0 BC.</skos:definition>
        ...
        <skos:broader rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/-0${ccminusrev}"/>
        <time:intervalMeets rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/-0${decaderevminus}"/>
        <time:intervalMetBy rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/-0${decaderevplus}"/>
      </rdf:Description>
