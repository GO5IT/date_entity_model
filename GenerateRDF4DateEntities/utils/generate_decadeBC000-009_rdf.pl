...
YEAR: for (my $yyyy=$year; $yyyy <= $yearmax; $yyyy++)  {
     ...
     my $output = <<"EOF";
      <rdf:Description rdf:about="https://vocabs.acdh.oeaw.ac.at/date/-00${decaderev}">
        ...
        <skos:altLabel xml:lang="en"> -00${decaderev}8/-00${decaderevminus}9</skos:altLabel>
        <skos:altLabel xml:lang="en"> ${decaderev}9 BC - ${decaderev}0 BC</skos:altLabel>
        <skos:definition xml:lang="en">A decade from -00${decaderev}8 to -00${decaderevminus}9 in ISO8601 (the Gregorian and proleptic Gregorian calendar). From ${decaderev}9 BC to ${decaderev}0 BC.</skos:definition>
        ...
        <time:intervalMeets rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/-00${decaderevminus}"/>
        <time:intervalMetBy rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/-00${decaderevplus}"/>
      </rdf:Description>
