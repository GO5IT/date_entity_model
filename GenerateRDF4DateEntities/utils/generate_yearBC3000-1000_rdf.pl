...
YEAR: for (my $yyyy=$year; $yyyy <= $yearmax; $yyyy++)  {
     ...
     my $output = <<"EOF";
      <rdf:Description rdf:about="https://vocabs.acdh.oeaw.ac.at/date/$yyyy">
        ...
        <skos:definition xml:lang="en">Year $yyyy in ISO8601 (the Gregorian and proleptic Gregorian calendar). Year $yyyyrevplus BC.</skos:definition>
        ...
        <time:intervalMeets rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/$yyyyplus"/>
        <time:intervalMetBy rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/$yyyyminus"/>
      </rdf:Description>
