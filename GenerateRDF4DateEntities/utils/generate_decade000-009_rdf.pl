...
YEAR: for (my $yyyy=$year; $yyyy <= $yearmax; $yyyy++)  {
     ...
     my $output = <<"EOF";
      <rdf:Description rdf:about="https://vocabs.acdh.oeaw.ac.at/date/00$decade">
        ...
        <skos:altLabel xml:lang="en">00${decade}0/00${decade}9</skos:altLabel>
        <skos:altLabel xml:lang="en">00${decade}0-00${decade}9</skos:altLabel>
        <skos:altLabel xml:lang="en">AD ${decade}0 - AD ${decade}9</skos:altLabel>
        <skos:definition xml:lang="en">A decade from 00${decade}0 to 00${decade}9 in ISO8601 (the Gregorian and proleptic Gregorian calendar). From AD ${decade}0 to AD ${decade}9.</skos:definition>
        ...
        <time:intervalMeets rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/00$decadeplus"/>
        <time:intervalMetBy rdf:resource="https://vocabs.acdh.oeaw.ac.at/date/00$decademinus"/>
      </rdf:Description>
